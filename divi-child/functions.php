...
{
  ob_start();
  include(get_stylesheet_directory() . '/php/doula_cards.php');
  return ob_get_clean();
}
add_shortcode('doula_cards_shortcode', 'doula_cards_shortcode');

function filter_search_shortcode(){
  ob_start();
  include(get_stylesheet_directory() . '/php/search_filter.php');
  return ob_get_clean();
}
add_shortcode('filter_search_shortcode', 'filter_search_shortcode');
